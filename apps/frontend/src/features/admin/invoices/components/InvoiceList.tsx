...
const InvoiceList = () => {
  ...
  if (!invoices || invoices.length === 0) return <div className="text-center py-4">領収書がありません</div>;
      ...
      <table className="min-w-full divide-y divide-gray-200">
        <thead className="bg-gray-50">
          <tr>
            ...
            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">領収書番号</th>
                  ...
                  <div className="flex items-center">
                    {editingInvoiceId === invoice.id ? (
                      ...
                      <div className="text-sm font-medium text-gray-900">
                        <Link href={`/admin/invoices/${invoice.id}`} className="hover:text-blue-500">
                    ...
                    <div className="text-sm text-gray-900">
                      ...
                      >
                        {invoice.status === 'PAID' ? '支払済み' : 
                         invoice.status === 'CANCELLED' ? 'キャンセル' : '未払い'}
                      </span>
                    </div>
                  )}
                </td>
                  ...
                  <div className="flex items-center justify-end space-x-2">
                    {editingInvoiceId === invoice.id ? (
                      ...
                      <>
                        ...
                        >
                          {expandedInvoiceId === invoice.id ? <RiArrowDownSLine /> : <RiArrowRightSLine />}
                        </button>
                        <button
                    ...
                    <div className="p-2">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <p>{invoice.due_date ? new Date(invoice.due_date).toLocaleDateString() : "期限なし"}</p>
                        </div>
                        <div>
