...
const saleProducts = [
  ...
  },
  {
    ...
    price: 24600,
    description: '最新のノイズキャンセリング技術を搭載したワイヤレスヘッドフォン。30時間のバッテリー寿命。期間限定25%オフ！',
  ...
  },
  {
    ...
    price: 2980,
    description: '環境に優しいオーガニックコットン100%使用。肌触りが良く、着心地抜群のTシャツ。期間限定40%オフ！',
  ...
  },
  {
    ...
    price: 32800,
    description: '健康管理、通知、GPS機能を搭載した最新のスマートウォッチ。防水機能付き。期間限定20%オフ！',
  ...
  },
  {
    ...
    name: 'ポータブル充電器【セール】',
    price: 3980,
    description: '10000mAhの大容量バッテリー。複数のデバイスを同時に充電可能。コンパクトで持ち運びに便利。期間限定50%オフ！',
    imageUrl: 'https://images.unsplash.com/photo-1583863788434-e58a36330cf0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1074&q=80',
  },
  {
    id: 106,
    ...
    imageUrl: 'https://images.unsplash.com/photo-1602143407151-7111542de6e8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1587&q=80',
  },
];
