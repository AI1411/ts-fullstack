...
import type { ChatMessageWithSender } from '@/features/admin/chats/controllers';
...
describe('MessageList Component', () => {
  ...
  it('should handle messages with long content', () => {
    const longMessage =
      'This is a very long message that should still be displayed correctly in the message list component without any issues with overflow or layout problems.';
    const mockMessages: ChatMessageWithSender[] = [
      {
        message: {
          id: 1,
