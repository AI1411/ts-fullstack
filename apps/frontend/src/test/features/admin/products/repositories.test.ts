...
import type { CreateProductInput } from '@/features/admin/products/controllers';
...
describe('Product Repository', () => {
  ...
  describe('createProduct', () => {
    it('should call client.products.$post with correct parameters', async () => {
      ...
      // Mock response
      const mockResponse = { ok: true };
      vi.mocked(client.products.$post).mockResolvedValue(
        mockResponse as Response
      );
  ...
  describe('getProductById', () => {
    it('should call client.products[":id"].$get with correct parameters', async () => {
      // Mock response
      const mockResponse = { ok: true };
      vi.mocked(client.products[':id'].$get).mockResolvedValue(
        mockResponse as Response
      );
  ...
  describe('updateProduct', () => {
    it('should call client.products[":id"].$put with correct parameters', async () => {
      ...
      // Mock response
      const mockResponse = { ok: true };
      vi.mocked(client.products[':id'].$put).mockResolvedValue(
        mockResponse as Response
      );
  ...
  describe('deleteProduct', () => {
    it('should call client.products[":id"].$delete with correct parameters', async () => {
      // Mock response
      const mockResponse = { ok: true };
      vi.mocked(client.products[':id'].$delete).mockResolvedValue(
        mockResponse as Response
      );
