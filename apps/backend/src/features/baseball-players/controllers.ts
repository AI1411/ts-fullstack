...
export const createBaseballPlayer = async (c: Context) => {
  ...
  try {
    ...
    if (data.birth_date !== undefined)
      playerData.birth_date = new Date(data.birth_date);
    ...
    if (data.throwing_hand !== undefined)
      playerData.throwing_hand = data.throwing_hand;
    if (data.batting_hand !== undefined)
      playerData.batting_hand = data.batting_hand;
    if (data.uniform_number !== undefined)
      playerData.uniform_number = data.uniform_number;
    if (data.nationality !== undefined)
      playerData.nationality = data.nationality;
    if (data.profile_image_url !== undefined)
      playerData.profile_image_url = data.profile_image_url;

    // 打撃成績
    if (data.batting_average !== undefined)
      playerData.batting_average = data.batting_average;
    if (data.games_played !== undefined)
      playerData.games_played = data.games_played;
    ...
    if (data.runs_batted_in !== undefined)
      playerData.runs_batted_in = data.runs_batted_in;
    if (data.runs_scored !== undefined)
      playerData.runs_scored = data.runs_scored;
    if (data.stolen_bases !== undefined)
      playerData.stolen_bases = data.stolen_bases;
    if (data.walks !== undefined) playerData.walks = data.walks;
    if (data.strikeouts !== undefined) playerData.strikeouts = data.strikeouts;
    if (data.on_base_percentage !== undefined)
      playerData.on_base_percentage = data.on_base_percentage;
    if (data.slugging_percentage !== undefined)
      playerData.slugging_percentage = data.slugging_percentage;
    ...
    if (data.games_pitched !== undefined)
      playerData.games_pitched = data.games_pitched;
    if (data.games_started !== undefined)
      playerData.games_started = data.games_started;
    if (data.complete_games !== undefined)
      playerData.complete_games = data.complete_games;
    if (data.shutouts !== undefined) playerData.shutouts = data.shutouts;
    if (data.innings_pitched !== undefined)
      playerData.innings_pitched = data.innings_pitched;
    if (data.hits_allowed !== undefined)
      playerData.hits_allowed = data.hits_allowed;
    if (data.runs_allowed !== undefined)
      playerData.runs_allowed = data.runs_allowed;
    if (data.earned_runs !== undefined)
      playerData.earned_runs = data.earned_runs;
    if (data.walks_allowed !== undefined)
      playerData.walks_allowed = data.walks_allowed;
    if (data.strikeouts_pitched !== undefined)
      playerData.strikeouts_pitched = data.strikeouts_pitched;
    if (data.whip !== undefined) playerData.whip = data.whip;

    // 契約情報
    if (data.contract_status !== undefined)
      playerData.contract_status = data.contract_status;
    if (data.salary !== undefined) playerData.salary = data.salary;
    if (data.contract_start_date !== undefined)
      playerData.contract_start_date = new Date(data.contract_start_date);
    if (data.contract_end_date !== undefined)
      playerData.contract_end_date = new Date(data.contract_end_date);
...
export const updateBaseballPlayer = async (c: Context) => {
  ...
  try {
    ...
    if (data.throwing_hand !== undefined)
      updateData.throwing_hand = data.throwing_hand;
    if (data.batting_hand !== undefined)
      updateData.batting_hand = data.batting_hand;
    if (data.uniform_number !== undefined)
      updateData.uniform_number = data.uniform_number;
    if (data.nationality !== undefined)
    ...
    // 打撃成績
    if (data.batting_average !== undefined)
      updateData.batting_average = data.batting_average;
    if (data.games_played !== undefined)
      updateData.games_played = data.games_played;
    ...
    if (data.runs_batted_in !== undefined)
      updateData.runs_batted_in = data.runs_batted_in;
    if (data.runs_scored !== undefined)
      updateData.runs_scored = data.runs_scored;
    if (data.stolen_bases !== undefined)
      updateData.stolen_bases = data.stolen_bases;
    if (data.walks !== undefined) updateData.walks = data.walks;
    if (data.strikeouts !== undefined) updateData.strikeouts = data.strikeouts;
    if (data.on_base_percentage !== undefined)
      updateData.on_base_percentage = data.on_base_percentage;
    if (data.slugging_percentage !== undefined)
      updateData.slugging_percentage = data.slugging_percentage;
    ...
    if (data.games_pitched !== undefined)
      updateData.games_pitched = data.games_pitched;
    if (data.games_started !== undefined)
      updateData.games_started = data.games_started;
    if (data.complete_games !== undefined)
      updateData.complete_games = data.complete_games;
    if (data.shutouts !== undefined) updateData.shutouts = data.shutouts;
    if (data.innings_pitched !== undefined)
      updateData.innings_pitched = data.innings_pitched;
    if (data.hits_allowed !== undefined)
      updateData.hits_allowed = data.hits_allowed;
    if (data.runs_allowed !== undefined)
      updateData.runs_allowed = data.runs_allowed;
    if (data.earned_runs !== undefined)
      updateData.earned_runs = data.earned_runs;
    if (data.walks_allowed !== undefined)
      updateData.walks_allowed = data.walks_allowed;
    if (data.strikeouts_pitched !== undefined)
      updateData.strikeouts_pitched = data.strikeouts_pitched;
    if (data.whip !== undefined) updateData.whip = data.whip;

    // 契約情報
    if (data.contract_status !== undefined)
      updateData.contract_status = data.contract_status;
    if (data.salary !== undefined) updateData.salary = data.salary;
    if (data.contract_start_date !== undefined)
      updateData.contract_start_date = new Date(data.contract_start_date);
    if (data.contract_end_date !== undefined)
      updateData.contract_end_date = new Date(data.contract_end_date);

    updateData.updated_at = new Date();

    // 選手を更新
    const updatedPlayer = await db
      .update(baseballPlayersTable)
      .set(updateData)
      .where(eq(baseballPlayersTable.id, id))
      .returning();
