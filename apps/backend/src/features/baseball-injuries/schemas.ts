...
export const baseballInjurySchema = z
  .object({
    ...
    status: z.string().optional().openapi({
      description:
        '状態（ACTIVE: 療養中, RECOVERED: 回復, SEASON_ENDING: シーズン終了）',
      example: 'ACTIVE',
    }),
...
export const baseballInjuryResponseSchema = z
  .object({
    id: z.number().openapi({
      description: '怪我記録ID',
      example: 1,
...
export const baseballInjuryUpdateSchema = z
  .object({
